...
use Magento\Sales\Model\Order\Invoice\Item as SalesInvoiceItem;
use Mageplaza\RewardPointsUltimate\Api\Data\InvoiceItemInterface;

/**
 * Class OrderItem
 * @package Mageplaza\RewardPointsUltimate\Model
 */
class InvoiceItem extends SalesInvoiceItem implements InvoiceItemInterface
{
    /**
     * {@inheritdoc}
     */
