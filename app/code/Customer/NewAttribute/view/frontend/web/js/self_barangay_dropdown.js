require(['jquery', 'mage/url'], function ($, urlBuilder) {
    $(document).ready(function () {
        ...
        $('#citydropselfemployed').change(function () {
            var cityId = $(this).val();
            ...
            $.ajax({
                ...
                success: function (response) {
                       ...
                       $('#barangaydropselfemployed').empty().val('');
                       $('#barangay_title').val('');
                       $('#barangay_id').val('');

                       var selectedValue = cityId;
                       $('#barangaydropselfemployed').val(selectedValue);
                    ...
                    if (response.length > 0) {
                        ...
                        $.each(response, function (index, option) {
                            ...
                            $('#barangaydropselfemployed').append($option);
                        });
                    } else {
