...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $tableName = $installer->getTable('customer_city');
        $tableComment = 'City table';
        $columns = array(
            'customer_city_id' => array(
                'type' => Table::TYPE_INTEGER,
                'size' => null,
                'options' => array('identity' => true, 'unsigned' => true, 'nullable' => false, 'primary' => true),
                'comment' => 'Customer City ID',
            ),
            'customer_city_created_at' => array(
                'type' => Table::TYPE_TIMESTAMP,
                'size' => 100,
                'options' => array('nullable' => false, 'default' => Table::TIMESTAMP_INIT),
                'comment' => 'Customer City Creation Time',
            ),
            'customer_city_updated_at' => array(
                'type' => Table::TYPE_TIMESTAMP,
                'size' => 100,
                'options' => array('nullable' => false, 'default' => Table::TIMESTAMP_INIT_UPDATE),
                'comment' => 'Customer City Modification Time',
            ),
            'customer_city_title' => array(
                'type' => Table::TYPE_TEXT,
                'size' => 255,
                'options' => array('nullable' => false, 'default' => ''),
                'comment' => 'Customer City Title',
            ),

            'customer_parent_city_id' => array(
                'type' => Table::TYPE_INTEGER,
                'size' => null,
                'options' => array( 'nullable' => false),
                'comment' => 'Customer Parent City ID',
            ),
        );
